...
from basic_layer import Residual_Block
...
class AttentionModule_pre(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, size1, size2, size3):
        ...
        self.softmax1_blocks = Residual_Block(in_channels, out_channels)

        self.skip1_connection_residual_block = Residual_Block(in_channels, out_channels)

        self.mpool2 = nn.MaxPool2d(kernel_size=3, stride=2, padding=1)

        self.softmax2_blocks = Residual_Block(in_channels, out_channels)

        self.skip2_connection_residual_block = Residual_Block(in_channels, out_channels)
        ...
        self.softmax4_blocks = Residual_Block(in_channels, out_channels)

        self.interpolation2 = nn.UpsamplingBilinear2d(size=size2)

        self.softmax5_blocks = Residual_Block(in_channels, out_channels)
        ...
        self.last_blocks = Residual_Block(in_channels, out_channels)
...
class AttentionModule_stage0(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, size1=(112, 112), size2=(56, 56), size3=(28, 28), size4=(14, 14)):
        ...
        self.mpool3 = nn.MaxPool2d(kernel_size=3, stride=2, padding=1)
        # 14*14
        self.softmax3_blocks = Residual_Block(in_channels, out_channels)
        self.skip3_connection_residual_block = Residual_Block(in_channels, out_channels)
        ...
        self.softmax5_blocks = Residual_Block(in_channels, out_channels)
        self.interpolation3 = nn.UpsamplingBilinear2d(size=size3)
        self.softmax6_blocks = Residual_Block(in_channels, out_channels)
        self.interpolation2 = nn.UpsamplingBilinear2d(size=size2)
        self.softmax7_blocks = Residual_Block(in_channels, out_channels)
        self.interpolation1 = nn.UpsamplingBilinear2d(size=size1)
...
class AttentionModule_stage1_cifar(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, size1=(16, 16), size2=(8, 8)):
        ...
        self.down_residual_blocks1 = Residual_Block(in_channels, out_channels)
        ...
        self.up_residual_blocks1 = Residual_Block(in_channels, out_channels)
